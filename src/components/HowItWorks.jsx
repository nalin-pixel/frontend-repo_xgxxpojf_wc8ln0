...
const HowItWorks = () => {
  const steps = [
    {
      title: 'Conta os teus objetivos',
      description: 'Indica metas de saúde, rotina e preferências alimentares.'
    },
    {
      title: 'Recebe um plano inteligente',
      description: 'O Wellio cria hábitos e metas personalizadas para ti.'
    },
    {
      title: 'Acompanha com praticidade',
      description: 'Regista refeições por texto, fotografia ou voz e acompanha tudo em gráficos.'
    },
    {
      title: 'Evolui com a IA',
      description: 'O coach identifica padrões e ajusta recomendações conforme o teu progresso.'
    },
  ];
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-600 max-w-2xl mx-auto">Um processo simples, guiado por IA, para transformar a tua rotina com consistência.</p>
        </div>
